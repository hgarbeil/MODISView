...
/**
 * @brief Imwidget::loadQImage_alt - create qimage which is the daytime LST file for this app
 * @param dat UInt16*  image data
 * @param ns  Int number of samples
 * @param nl  Int number of lines
 */
...
/**
 * @brief Imwidget::setNightFlag - public method to change the nightFlag class member
 * @param nflag - true for night
 */
...
/**
 * @brief Imwidget::mousePressEvent - mouse clicks
 * @param ev MousePressEvent generated by the click
 *
 */
